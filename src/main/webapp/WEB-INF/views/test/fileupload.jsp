                ...
                <form method="post" enctype="multipart/form-data" action="${path1}/file/fileupload1.do">
                    <div class="control">
                        <label for="file1" class="file-label">
                            ...
                            <input type="file" name="files" id="file1" class="file-input" required>
                            <span class="file-cta">
                    ...
                    <div class="control">
                        <label for="file2" class="file-label">
                            ...
                            <input type="file" name="files" id="file2" class="file-input" required>
                            <span class="file-cta">
                              <span class="file-icon">
                                <i class="fas fa-upload"></i>
                              </span>
                    ...
                    <div class="control">
                        <label for="file3" class="file-label">
                            ...
                            <input type="file" name="files" id="file3" class="file-input" required>
                            <span class="file-cta">
                              <span class="file-icon">
                                <i class="fas fa-upload"></i>
                              </span>
