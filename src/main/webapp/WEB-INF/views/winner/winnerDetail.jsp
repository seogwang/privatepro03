	      ...
	      <div class="container">
		      <table id="table1">
				...
				<div class="button-group">
				  ...
				  <a class="button is-primary" href="${path999 }/winner/delete.do?bno=${dto.bno}">글 삭제</a>
				  <a class="button is-danger" href="${path999 }/winner/edit.do?bno=${dto.bno}">글 수정</a>
				</div>
	      </div>
	    </div>
	</div>
